...
private:
    ...
    // (qpk): indicates that the exit edge was found on myRoute when entering an parking queue
    /// @brief indicates that the exit edge was found on myRoute when entering an parking queue
    bool myFoundExitEdgeOnMyRoute;
