...
//#define DEBUG_COND (getID() == "f_eAuto3.34")
//#define DEBUG_COND (true)
#define DEBUG_COND (isSelected())
//#define DEBUG_COND2(obj) (obj->getID() == "f_eAuto3.34")
...
#pragma warning(pop)
        ...
        if (!myStops.empty()
            ...
            if (stop.parkingarea != nullptr) {
                ...
                // (utl): a vehicle approaches a fully occupied parking area and wants to go by to trigger the rerouter,
...
MSVehicle::rerouteParkingArea(const std::string& parkingAreaID, std::string& errorMsg) {
    ...
    // (utl): Use the compute-Method that considers the position
